...
class _BudgetPageState extends State<BudgetPage> {
  ...
  void didChangeDependencies() {
    ...
    _initializeControllers(categories, budget);
    _controllersInitialized = true;
  }

  void _initializeControllers(List<Category> categories, Budget budget) {
    _totalCtrl.text =
  ...
  void dispose() {
    _totalCtrl.dispose();
    for (final controller in _categoryCtrls.values) {
      controller.dispose();
    }
    super.dispose();
  }
