...
class CategoryRepository {
  ...
  static final List<Category> defaultCategories = [
    Category(
      key: 'food',
      name: AppStrings.catFood,
      icon: Icons.restaurant_outlined,
      isExpense: true,
    ),
    Category(
      key: 'shopping',
      name: AppStrings.catShopping,
    ...
    Category(
      key: 'utility',
      name: AppStrings.catUtility,
      icon: Icons.electric_bolt,
      isExpense: true,
    ),
    Category(
      key: 'medical',
      name: AppStrings.catMedical,
    ...
    Category(
      key: 'daily',
      name: AppStrings.catDaily,
      icon: Icons.inventory_2_outlined,
      isExpense: true,
    ),
    Category(
      key: 'pet',
      name: AppStrings.catPet,
    ...
    Category(
      key: 'parttime',
      name: AppStrings.catParttime,
      icon: Icons.work_outline,
      isExpense: false,
    ),
    Category(
      key: 'invest',
      name: AppStrings.catInvest,
